...
<Aside type="caution">
  Setelah mengubah file `.env`, jalankan perintah berikut untuk menerapkan perubahan:
  <Code code={`docker compose -f /opt/ildis/docker-compose.yml --env-file /opt/ildis/.env up -d`} lang="shell" />
</Aside>
